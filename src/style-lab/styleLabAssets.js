...
export const PLAYER_SHEETS = [
    { key: 'lab_player_down', anim: 'lab_walk_down', path: 'asset/player_walk_down.png', frameWidth: 266, frameHeight: 431, frameRate: 6 },
    { key: 'lab_player_up', anim: 'lab_walk_up', path: 'asset/player_walk_up.png', frameWidth: 231, frameHeight: 394, frameRate: 6 },
    { key: 'lab_player_left', anim: 'lab_walk_left', path: 'asset/player_walk_left.png', frameWidth: 251, frameHeight: 446, frameRate: 6 },
    { key: 'lab_player_right', anim: 'lab_walk_right', path: 'asset/player_walk_right.png', frameWidth: 251, frameHeight: 446, frameRate: 6 }
];

export const MOMO_SHEETS = [
    { key: 'lab_momo_active', anim: 'lab_momo_run', path: 'concepts/current/momo-sheets/animated/momo-active-follow-animated-sheet.png', frameRate: 8 },
    { key: 'lab_momo_sleepy', anim: 'lab_momo_sleepy', path: 'concepts/current/momo-sheets/animated/momo-sleepy-yawn-animated-sheet.png', frameRate: 4 },
    { key: 'lab_momo_curled', anim: 'lab_momo_curled', path: 'concepts/current/momo-sheets/animated/momo-low-energy-curled-animated-sheet.png', frameRate: 4 },
    { key: 'lab_momo_silent', anim: 'lab_momo_silent', path: 'concepts/current/momo-sheets/animated/momo-silent-breathing-animated-sheet.png', frameRate: 5 },
    { key: 'lab_momo_hug', anim: 'lab_momo_hug', path: 'concepts/current/momo-sheets/animated/momo-hug-ready-animated-sheet.png', frameRate: 5 },
    { key: 'lab_momo_breath', anim: 'lab_momo_breath', path: 'concepts/current/momo-sheets/animated/momo-dandelion-breath-animated-sheet.png', frameRate: 5 }
];

export const GRANDMA_ROCKING_SHEET = {
    key: 'lab_grandma_rocking',
    anim: 'lab_grandma_idle',
    path: 'concepts/current/grandma/grandma-rocking-chair-sheet.png',
    frameWidth: 240,
    frameHeight: 320,
    frameRate: 4
};
